...
public class Util {
    ...
    public static void generate(HomeController ct) {
        ...
        for (int i = 0; i < amount; i++) {
            passwords.add(RandomStringUtils.random(length, sb.toString()));
    ...
    public static String generateSingle(HomeController ct) {
        StringBuilder sb = new StringBuilder();
        if (ct.cbCaps.isSelected()) {
            sb.append(CharacterSet.CAPS.getChars());
        }
